...
/datum/component/material_container/crude/retrieve_sheets(sheet_amt, datum/material/M, target, atom/context = parent)
...
/datum/component/material_container/crude/on_examine(datum/source, mob/user)
