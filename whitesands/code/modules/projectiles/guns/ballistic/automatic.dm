/obj/item/gun/ballistic/automatic/solar
	...
	spawn_magazine_type = /obj/item/ammo_box/magazine/rifle47x33mm
	can_suppress = FALSE
	actions_types = list()
	can_bayonet = FALSE
	mag_display = TRUE
...
/obj/item/gun/ballistic/automatic/aks74u
	...
	accepted_magazine_type = /obj/item/ammo_box/magazine/aks74u
...
/obj/item/gun/ballistic/automatic/pistol/tec9
	...
	weapon_weight = WEAPON_LIGHT
	w_class = WEIGHT_CLASS_SMALL
	accepted_magazine_type = /obj/item/ammo_box/magazine/tec9
	semi_auto = FALSE
	mag_display = TRUE
...
/obj/item/gun/ballistic/automatic/ebr
	...
	icon = 'whitesands/icons/obj/guns/48x32guns.dmi'
	icon_state = "ebr"
	inhand_icon_state = "ebr"
	mag_display = TRUE
	weapon_weight = WEAPON_MEDIUM
	w_class = WEIGHT_CLASS_BULKY
	accepted_magazine_type = /obj/item/ammo_box/magazine/ebr
